    ...
    <header className="sticky top-0 z-50 bg-white shadow-md border-b-2 border-gray-100">
      ...
      {isMenuOpen && (
        <div className="lg:hidden bg-white border-t-2 border-gray-100 py-6 px-4 space-y-2 shadow-2xl animate-in slide-in-from-top duration-300">
          ...
          <div className="pt-6 border-t border-gray-100 flex justify-center space-x-10 text-indigo-700">
             ...
             <a href="#" className="hover:scale-125 transition-transform"><Send size={24} /></a>
             <a href="#" className="hover:scale-125 transition-transform"><MessageCircle size={24} /></a>
          </div>
        </div>
      )}
    </header>
